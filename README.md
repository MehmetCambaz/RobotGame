...
We use this test as an indication of the kind of code that a candidate would write on a day to day basis, so
please take your time and submit representative code.
Important – Please read the requirements carefully
You should aim to deliver production ready code, and your repository should be structured as you would if
you were setting up a real repository.
• Please use Git to track your changes, after you have completed, upload your code to GitHub and
share the URL with us. Complete Git commit history must be present.
• You must use C# to complete the exercise and demonstrate your understanding of software
engineering principles and best practices.
• Unit tests must be included, you can choose any testing library.
• You may choose how the application handles user inputs:
o From a file
o From standard input
• Provide test data to exercise the application.
Requirements
You are tasked to implement a simple Toy Robot game simulation.
